...
<template>
  ...
  <Header_Component />
    ...
    <div class="w-full mx-auto rounded-lg bg-white p-5 text-gray-700" style="max-width: 600px">
        ...
        <div class="mb-3 flex -mx-2">
            <div class="px-2">
                <label for="type1" class="flex items-center cursor-pointer">
                    <input type="radio" class="form-radio h-5 w-5 text-blue" name="type" id="type1" checked>
                    <img src="https://leadershipmemphis.org/wp-content/uploads/2020/08/780370.png" class="h-8 ml-3">
                </label>
            </div>
            <div class="px-2">
                <label for="type2" class="flex items-center cursor-pointer">
                    <input type="radio" class="form-radio h-5 w-5 text-blue" name="type" id="type2">
                    <img src="https://www.sketchappsources.com/resources/source-image/PayPalCard.png" class="h-8 ml-3">
                </label>
            </div>
        </div>
        <div class="mb-3">
            <label class="font-bold text-sm mb-2 ml-1">名前</label>
            <div>
        ...
        <div class="mb-3">
            <label class="font-bold text-sm mb-2 ml-1">カード番号</label>
            <div>
        ...
        <div class="mb-3 -mx-2 flex items-end">
            <div class="px-2 w-1/2">
                <label class="font-bold text-sm mb-2 ml-1">有効期限</label>
                <div>
        ...
        <div class="mb-10">
            <label class="font-bold text-sm mb-2 ml-1">CVC番号</label>
            <div>
        ...
        <div>
            <button @click="submitOrder" class="block w-full max-w-xs mx-auto text-white bg-blue-btn rounded-lg px-3 py-3 font-semibold"><i class="mdi mdi-lock-outline mr-1"></i> 購入</button>
        </div>
        <div class="mt-4">
          <Link
            href="/carts"
